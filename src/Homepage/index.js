    ...
    return (
      <div>
        <div className="user-collection-container">
          ...
          <div>
            <button className='update-profile-button'><Link className='update-link' to='/homepage/update'>Update Your Profile</Link></button>
          </div>
          ...
          <div className="album-collection-container">
            <div className='vinyl-collection'>
              <h2 className='vinyl-collection-h2'>Your Collection</h2>
            </div>
